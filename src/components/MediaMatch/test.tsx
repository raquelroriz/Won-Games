...
describe('<MediaMatch />', () => {
  ...
  // hook tests, beforeEach significa que será criado certas coisas nesse bloco
  // que será usado para todos os demais IT criados (se fosse depois seria afterEach)
  beforeEach(() => {
    render(
      <>
